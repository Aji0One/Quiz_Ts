...
import Msq from "../questionsType/msq";
...
describe("Msq", () => {
    ...
    test("Initial rendering", () => {
        ...
        render(<stateContest.Provider value={contextMockValue}><Msq id={id} key={key} num={num} setrender={setrender} /></stateContest.Provider>)
